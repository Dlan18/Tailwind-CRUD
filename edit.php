    ...
    <div class="flex-grow flex flex-col">
      <div class="m-5 p-7 bg-slate-100 rounded-lg shadow-xl">
          ...
          <form action="" method="POST">
            ...
            <h3 class="my-4 font-bold text-lg">Edit Data Siswa</h3>
            <div class="mb-3">
            ...
            <button><a href="index.php" class="mr-1 px-4 py-2 bg-slate-500 text-white hover:bg-slate-600 rounded" style="letter-spacing: 0.5px" type="submit">BATAL</a></button>
